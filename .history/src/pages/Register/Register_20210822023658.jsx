    ...
    <div className="container">
      <div>
        ...
        <form>
          ...
          <Input placeholderProp="CEP" id="CEP" />
          <Input placeholderProp="Rua" id="rua" />
          <Input placeholderProp="Bairro" id="bairro" />
          <Input placeholderProp="Cidade" id="cidade" />
          <Input placeholderProp="Estado" id="estado"/>
